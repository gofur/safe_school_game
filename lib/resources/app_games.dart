...
List<Game> appGames = [
  ...
  Game(
      ...
      description:
          "Happy Pirate Wow adalah permainan yang mengandalkan ketangkasan dimana anak-anak diajak untuk bermain dengan menghindari ancaman yang akan dihadapi oleh pemain di dalam permainan. Dengan tujuan agar anak-anak belajar untuk mengenali bencana yang perlu mereka hindari. Cara memainkan permainan ini dilakukan dengan menyentuh layar gawai (tap pada layar mobile phone) dan mengikuti pergerakan dengan melepas sentuhan untuk mengatur jalannya permainan.",
      difficult: 5,
      educationContent: 2,
      ageUse: "6 - 12 Tahun",
      images: [
